...
type ServerInfo struct {
	...
	BackendSpace         uint64   `protobuf:"varint,21,opt,name=backend_space,json=backendSpace,proto3" json:"backend_space,omitempty"`
	BackendUsed          uint64   `protobuf:"varint,22,opt,name=backend_used,json=backendUsed,proto3" json:"backend_used,omitempty"`
	NextRecordId         uint64   `protobuf:"varint,23,opt,name=next_record_id,json=nextRecordId,proto3" json:"next_record_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ServerInfo) GetBackendSpace() uint64 {
	if m != nil {
		return m.BackendSpace
	}
	return 0
}

func (m *ServerInfo) GetBackendUsed() uint64 {
	if m != nil {
		return m.BackendUsed
	}
	return 0
}

func (m *ServerInfo) GetNextRecordId() uint64 {
	if m != nil {
		return m.NextRecordId
	}
	return 0
}
...
var fileDescriptor_33af41ac7b8d43b1 = []byte{
	...
	,
}
...
type SumServiceClient interface {
	...
	CreateRecords(ctx context.Context, in *Records, opts ...grpc.CallOption) (*RecordResponse, error)
...
func (c *sumServiceClient) CreateRecords(ctx context.Context, in *Records, opts ...grpc.CallOption) (*RecordResponse, error) {
	out := new(RecordResponse)
	err := c.cc.Invoke(ctx, "/sum.SumService/CreateRecords", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SumServiceServer interface {
	...
	CreateRecords(context.Context, *Records) (*RecordResponse, error)
...
func (*UnimplementedSumServiceServer) CreateRecords(ctx context.Context, req *Records) (*RecordResponse, error) {
...
func _SumService_CreateRecords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Records)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SumServiceServer).CreateRecords(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sum.SumService/CreateRecords",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SumServiceServer).CreateRecords(ctx, req.(*Records))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SumService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SumService_CreateRecords_Handler,
		},
		{
